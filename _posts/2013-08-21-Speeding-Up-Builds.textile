...
Testing is good. Testing saves developers time, catching bugs sooner rather than later. Testing saves money, catching bugs before the hit production. Testing shortens feature releases, allowing developers to change large bodies of code with confidence that problems will be caught by tests with "high code coverage":https://www.atlassian.com/software/clover/overview.
